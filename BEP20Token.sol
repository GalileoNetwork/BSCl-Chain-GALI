...
contract GALI is IERC20, Ownable {
    ...
    address public fund1Address = address(0x00f58738f6B2dbFf8266A5D6A7f7B09d402DAeBD);
    
    uint256 public _fund1Fee = 2;
    

    constructor(address tokenOwner) {
        _name = "GalileoNetwork";
        _symbol = "GALI";
        _decimals = 18;

        _tTotal = 10000000000 * 10**_decimals;
        uint256 leftAmount = 1000000000 * 10**_decimals;
